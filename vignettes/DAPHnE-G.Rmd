...
The pipeline has been developed in order to collect and automatize part of the analysis used in the *SNPstar* webserver. This is a database/data repository that aims to characterize the mutations of different ecotypes of *A.thaliana*. A part of this characterization involves association studies.
...
The choice to keep a backup archive was taken to have the possibility to synchronize the dataset to a previous version, in case a user notices some mistakes in a putative intermediate to last step.
