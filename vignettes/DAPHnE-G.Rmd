...
# Data
DAPHnE-G data repository consists of 7 tables (5 included in the package plus 2 external): a description of the ecotypes; a collection of environmental parameters and corresponding metadata; the phenotypic traits also with metadata. 
...
## Workflow without leave-one-chromosome-out approach
```{r, echo = F, out.width="100%" }
knitr::include_graphics("overview_DAPHNEG_locoF.png")
```

## Workflow with leave-one-chromosome-out approach
```{r, echo = F, out.width="100%" }
